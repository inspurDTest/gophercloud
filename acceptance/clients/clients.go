...
import (
	...
	baremetalHTTPBasic "github.com/inspurDTest/gophercloud/openstack/baremetal/httpbasic"
	baremetalNoAuth "github.com/inspurDTest/gophercloud/openstack/baremetal/noauth"
	blockstorageNoAuth "github.com/inspurDTest/gophercloud/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/inspurDTest/gophercloud/issues/1345
	if networkID == "" {
