...
* `github.com/inspurDTest/gophercloud/openstack/compute/v2/extensions/floatingip` is now `github.com/inspurDTest/gophercloud/openstack/compute/v2/extensions/floatingips`
